...
WebUI.setText(findTestObject('Object Repository/mss_LoginPageObjects/Page_Authentication B2B/input_Login_user'), 'user002')

WebUI.setText(findTestObject('Object Repository/mss_LoginPageObjects/Page_Authentication B2B/input_Password_pwd'), 'password@001')

WebUI.click(findTestObject('Object Repository/mss_LoginPageObjects/Page_Authentication B2B/button_Sign in'))

WebUI.verifyElementText(findTestObject('mss_LoginPageObjects/Page_Authentication B2B/Page_Authentication B2B/span_errorMsg'), 
    'Username or password are incorrect, please check your entry.')
