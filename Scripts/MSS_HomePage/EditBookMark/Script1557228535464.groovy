...
WebUI.click(findTestObject('Page_MyServiceSpace/span_Orange Team_dropup'))

WebUI.click(findTestObject('Page_MyServiceSpace/h5_Edit'))

WebUI.verifyElementNotClickable(findTestObject('Editbookmark_objects/input_Label_forminput inputlabel'))

WebUI.getText(findTestObject('Editbookmark_objects/input_Label_forminput inputlabel'))
